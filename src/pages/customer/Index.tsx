...
export const Home: React.FC = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      if (fieldRes.success) setApiFields(fieldRes.data.slice(0, 6));
      if (productRes.success) setApiProducts(productRes.data.slice(0, 6));
    } catch (error: unknown) {
  ...
  return (
    <div className="bg-emerald-50/30 overflow-x-hidden">
      {/* 1. HERO SECTION */}
      <section className="relative min-h-[60vh] md:min-h-[70vh] flex items-center overflow-hidden bg-emerald-900 py-12 md:py-20">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <span className="inline-block px-4 py-1.5 rounded-full bg-emerald-500/20 text-emerald-400 font-black text-[10px] md:text-xs uppercase tracking-[0.3em] mb-4 border border-emerald-500/30 backdrop-blur-md">
            ...
            <p className="text-sm md:text-base text-emerald-50/70 mb-8 max-w-xl leading-relaxed font-medium">
            ...
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="bg-emerald-500 hover:bg-emerald-400 text-white px-6 py-3 rounded-2xl font-black text-base shadow-xl shadow-emerald-500/30 transition-all flex items-center justify-center gap-2 group"
              >
                ĐẶT SÂN NGAY
              ...
              <button
                ...
                className="bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 text-white px-6 py-3 rounded-2xl font-black text-base transition-all"
              >
                XEM CỬA HÀNG
              </button>
            </div>
      ...
      <section className="py-16 md:py-20 container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div>
            <span className="text-emerald-600 font-black tracking-widest uppercase text-xs mb-3 block underline decoration-4 underline-offset-8">
              Booking System
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-emerald-950 uppercase italic">
              SÂN BÓNG <span className="text-emerald-600">ĐƯỢC YÊU THÍCH NHẤT</span>
            </h2>
          </div>
          <button
            onClick={() => navigate("/fields")}
            className="bg-emerald-900 text-white px-8 py-3 rounded-2xl font-black hover:bg-emerald-800 transition-all shadow-md text-sm uppercase tracking-wider"
          >
            TẤT CẢ SÂN
          </button>
        </div>
      ...
      <section className="py-16 md:py-20 bg-[#053d2f] relative rounded-[3rem] mx-4 md:mx-8 mb-16 shadow-2xl">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-black text-white mb-4 uppercase italic tracking-tight">
              CÁC SẢN PHẨM <span className="text-emerald-400">NỔI BẬT</span>
            </h2>
            <p className="text-emerald-100/60 text-sm md:text-base italic font-medium">
      ...
      <section className="py-16 md:py-20 container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <span className="text-emerald-600 font-black tracking-widest uppercase text-xs mb-3 block underline underline-offset-8">
              Siêu sao đồng hành
            </span>
            <h2 className="text-3xl md:text-4xl font-black text-emerald-950 italic mb-6 uppercase tracking-tighter">
